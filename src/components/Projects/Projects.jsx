...
const Projects = ()=>{
    ...
    let food = [swiggy, 'Swiggy Clone Online food Delivery',"I created a clone of one of the most famous online food delivery apps Swiggy. I used swiggy's live APIs to make the website. I used concepts like lazy loading, props drilling and made sure to make very minimal API calls to reduce the load. ","The webiste was made using ReactJS, Redux, and RestAPIs.",reactSvg] 
    let covidRescue = [covid,'Covid-19 Rescue System',"The website provided the Covid-19 patients the nearest hospital that they could reach by analysing the latitude and longitude of the user. the patients will also be provided with turn by turn navigation guidance along with the pitcure of a map. ","  This website was built using Python and Open Route Services API(for location).", pythonSvg]
