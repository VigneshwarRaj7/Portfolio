...
const Projects = ()=>{
    ...
    let music = [musicMental, 'Music Effect on Mental Health','The data set includes information about diﬀerent mental illness [anxiety, depression, OCD, & insomnia] of people, their favorite genre [Jazz, R&B, etc.], and their listening time. KNN and decision tree classifier has been performed to find out how different music genre coudl affect the mental health of people.','This model was built using Python and its libraries ( sklearn, numpy, & matplotlib).',pythonSvg];
    let food = [swiggy, 'Swiggy Clone Online food Delivery',"Created a clone of one of the most famous online food delivery apps Swiggy. I used swiggy's live APIs to make the website. I used concepts like lazy loading, props drilling and made sure to make very minimal API calls to reduce the load. ","The webiste was made using ReactJS, Redux, and RestAPIs.",reactSvg] 
    let covidRescue = [covid,'Covid-19 Rescue System',"The website provided the Covid-19 patients the nearest hospital that they could reach by analysing the latitude and longitude of the user. Further,the patients would be provided with turn by turn navigation guidance along with the pitcure of a map. ","  This website was built using Python and Open Route Services API(for location).", pythonSvg]

    return(
        <section id="projects">
        <div className="">
            <h1 className="font-techno mb-5 md:mb-10 md:mt-10 text-4xl text-center md:text-5xl font-extrabold"><Typewriter
          words={[
          'PROJECTS'
          ]}
          cursor
          ...
          onComplete={() => setSecondTyping(true)}
           /></h1>
            ...
            <ProjectCard data={music}></ProjectCard>       
            <ProjectCard data={food}></ProjectCard>            
            <ProjectCard data={covidRescue}></ProjectCard>                       
        </div>
        </section>
    )
}
